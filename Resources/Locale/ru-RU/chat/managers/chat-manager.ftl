...
chat-manager-ooc-chat-enabled-message = РАЗРЕШАЮ СРАТЬ.
chat-manager-ooc-chat-disabled-message = ЗАПРЕЩАЮ СРАТЬ.
...
chat-manager-sender-announcement-wrap-message = [font size=14][bold]Оповещение { $sender }:[/font][font size=12]
    { $message }[/bold][/font]
...
chat-speech-verb-name-pigwar = Свинья
chat-speech-verb-pigwar-strong = кряхтит
chat-speech-verb-name-oblezliy = Облезлый
chat-speech-verb-oblezliy-strong = ебнуто ворчит
chat-speech-verb-name-halber = Хальбер
chat-speech-verb-halber = изрыгает
