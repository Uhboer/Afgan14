...
reagent-name-lariy = ларий
reagent-desc-lariy = полезная штука
reagent-physical-desc-lariy = вязко-плотное
generic-reagent-effect-lariy = чё-то я переборщил...
generic-reagent-effect-lariy-head = бошка кружится...

reagent-name-morphine = морфий
reagent-desc-morphine = мощный боевой стимулятор
morphine-effect-ahuy = просто ахуенно
morphine-effect-zaebis = мне заебись
morphine-effect-kaif = я под кайфом
morphine-effect-pizdec = МОЯ КОЖА ПЛАВИТСЯ! ПИЗДЕЦ!
morphine-effect-death = УБЕЙТЕ МЕНЯ
morphine-effect-end = ЭТО ТАКОЙ КОНЕЦ

reagent-name-materit = материт
reagent-desc-materit = токсин, который способен преобразовать жидкости в твёрдые тела.
materit-effect-burn = Я ГОРЮ

reagent-name-flamer = фламер
reagent-desc-flamer = огнеопасное вещество.
flamer-effect-burn = СУКААА!! ОГОНЬ!!

reagent-name-reliver = релайвер
reagent-desc-reliver = дарует вторую жизнь, но какой ценой...
reagent-physical-desc-reliver = зомбефецирующе

reagent-name-bombin = бомбин
