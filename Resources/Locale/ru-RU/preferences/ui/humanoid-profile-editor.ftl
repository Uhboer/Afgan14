...
humanoid-profile-editor-name-label = Погонялово:
...
humanoid-profile-editor-jobs-tab = Выбор Команды
...
humanoid-profile-editor-antags-tab = Негодяи
...
humanoid-profile-editor-naming-rules-warning = НЕ КАПСИТЕ В НИКИ, ИНАЧЕ Я ВАС БУДУ СМАЙТИТЬ
