job-description-technical-assistant = Вы - последний алхимик Афгана. Постройте торговые отношения с Афганом или Ортодоксами, экспериментируйте с грибами и так далее.
...
job-description-boxer = Ты и другие ортодоксы должны уничтожить афганцев любой ценой... Совершайте ритуалы, исследуйте пустошь и становитесь легендами.
...
job-description-captain = ХУЯРЬ ИХ
...
job-description-centcomoff = Я - НАСИЛИЕ.
...
job-description-engineer = Ты сошёл с ума. Раньше это место было делом всей твоей жизни, но сейчас тут царит хаос и анархия, из-за чего ты очень зол.
...
job-description-hop = Ты - агент ITOBE, твоя задача: сбежать. Сбежать из комплекса А.Ф.Г.А.Н.
...
job-description-janitor = Нужен для режима ВОЙНА ФРАКЦИЙ.
...
job-description-passenger = РЕКОМЕНДУЕТСЯ ДЛЯ НОВИЧКОВ. Ебашь во имя Аллаха, стреляй в ортодоксов и рабов, выживай на этой ебанутой планете вместе со своими соседями по дурке.
...
job-description-reporter = Ты и твои подопечные ортодоскы должны любой ценой захватить территорию Афганцев.
