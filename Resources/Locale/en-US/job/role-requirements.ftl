...
role-timer-age-to-old = Твоему персонажу должно быть меньше [color=yellow]{$age}[/color] чтобы взять роль.
role-timer-age-to-young = Твоему пресонажу должно быть больше [color=yellow]{$age}[/color] чтобы взять роль.
